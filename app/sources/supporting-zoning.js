  ...
  'source-layers': [
    {
      ...
      sql: 'SELECT the_geom_webmercator, cartodb_id, sdlbl, sdname FROM special_purpose_districts_v201811',
    },
    {
      id: 'special-purpose-subdistricts',
      sql: 'SELECT the_geom_webmercator, splbl, cartodb_id, spname, subdist FROM special_purpose_subdistricts_v201811',
    },
    {
    ...
    {
      id: 'sidewalk-cafes',
      sql: 'SELECT the_geom_webmercator, cafetype FROM sidewalk_cafes_v201811',
    },
    {
    ...
    },
    {
      ...
      sql: 'SELECT the_geom_webmercator, ulurpno, status, project_na FROM zoning_map_amendments_v201811 WHERE status = \'Certified\'',
    },
    {
      id: 'limited-height-districts',
      sql: 'SELECT the_geom_webmercator, lhlbl FROM limited_height_districts_v201811',
    },
    {
