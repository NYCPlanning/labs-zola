  ...
  'source-layers': [
    {
      ...
      sql: 'SELECT the_geom_webmercator, cartodb_id, sdlbl, sdname FROM special_purpose_districts_v201808',
    },
    {
    ...
    },
    {
      ...
      sql: 'SELECT the_geom_webmercator, projectnam, mih_option FROM mandatory_inclusionary_housing_v20180628',
    },
    {
