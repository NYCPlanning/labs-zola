export default {
  ...
  'source-layers': [
    ...
    },
    {
      ...
      sql: 'SELECT the_geom_webmercator, splbl, cartodb_id, spname, subdist FROM special_purpose_subdistricts_v201803',
    },
    {
      id: 'mandatory-inclusionary-housing',
      sql: 'SELECT the_geom_webmercator, projectnam, mih_option FROM mandatory_inclusionary_housing_v20180322',
    },
    {
    ...
    {
      id: 'sidewalk-cafes',
      sql: 'SELECT the_geom_webmercator, cafetype FROM sidewalk_cafes_v201803',
    },
    {
    ...
    },
    {
      ...
      sql: 'SELECT the_geom_webmercator, ulurpno, status, project_na FROM zoning_map_amendments_v201803 WHERE status = \'Certified\'',
    },
    {
      id: 'limited-height-districts',
      sql: 'SELECT the_geom_webmercator, lhlbl FROM limited_height_districts_v201803',
    },
    {
    ...
    {
      id: 'e-designations',
      sql: 'SELECT the_geom_webmercator, bbl, ceqr_num, enumber, ulurp_num FROM e_designations_v20180322',
    },
  ],
};
