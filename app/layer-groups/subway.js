export default {
  ...
  meta: {
    ...
    url: [
      'https://planninglabs.carto.com/api/v2/sql?q=SELECT * FROM support_trans_mta_subway_stops&format=SHP',
      'https://planninglabs.carto.com/api/v2/sql?q=SELECT * FROM support_trans_mta_subway_routes&format=SHP',
