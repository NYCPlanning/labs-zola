    ...
    mapboxStyle: {
      ...
      sources: {
        ...
        paws: {
          type: 'vector',
          tiles: [
            'https://cartocdn-gusc-b.global.ssl.fastly.net/planninglabs/api/v1/map/fef5b454f0ba9c5f48ace584cc970471:1558112157435/{z}/{x}/{y}.mvt',
          ],
        },
        'boat-launches': {
          type: 'vector',
          tiles: [
            'https://cartocdn-gusc-c.global.ssl.fastly.net/planninglabs/api/v1/map/149aa51f274d3284b0774904b8a60bb6:1539123038491/{z}/{x}/{y}.mvt',
          ],
        },
        'citibike-stations': {
          type: 'vector',
          tiles: [
            'https://cartocdn-gusc-d.global.ssl.fastly.net/planninglabs/api/v1/map/9736649f1b875cab7750cb8bf51d3231:1551751812048/{z}/{x}/{y}.mvt',
          ],
        },
        transportation: {
          type: 'vector',
          tiles: [
            'https://cartocdn-gusc-d.global.ssl.fastly.net/planninglabs/api/v1/map/eb09d39186e77a98deee1af8d95ac291:1539281332384/{z}/{x}/{y}.mvt',
          ],
        },
        'aerials-2016': {
          id: 'aerials-2016',
        ...
        ferries: {
          type: 'vector',
          tiles: [
            'https://cartocdn-gusc-a.global.ssl.fastly.net/planninglabs/api/v1/map/9c54896bcc49ffdef605a7899e9f88fe:1540307750946/{z}/{x}/{y}.mvt',
          ],
        },
        'admin-boundaries': {
          type: 'vector',
          tiles: [
            'https://cartocdn-gusc-c.global.ssl.fastly.net/planninglabs/api/v1/map/4c125b8904702b158c6a0df2becc1529:1544124560004/{z}/{x}/{y}.mvt',
          ],
        },
        'census-geoms': {
          type: 'vector',
          tiles: [
            'https://cartocdn-gusc-d.global.ssl.fastly.net/planninglabs/api/v1/map/c56a715ba29fc78afc72ded47505d8f6:1556821301040/{z}/{x}/{y}.mvt',
          ],
        },
        pluto: {
          type: 'vector',
          tiles: [
            'https://cartocdn-gusc-b.global.ssl.fastly.net/planninglabs/api/v1/map/48ae04eb9da20ed8fb5c7daeee70ca01:1555337545595/{z}/{x}/{y}.mvt',
          ],
        },
        'zoning-districts': {
          type: 'vector',
          tiles: [
            'https://cartocdn-gusc-b.global.ssl.fastly.net/planninglabs/api/v1/map/e236399b5f4e8802250cc921ea0b0ff2:1557779894209/{z}/{x}/{y}.mvt',
          ],
        },
        'digital-citymap': {
          type: 'vector',
          tiles: [
            'https://cartocdn-gusc-a.global.ssl.fastly.net/planninglabs/api/v1/map/7bf64326d2ba7e18f894299b36d49d0b:1536785962086/{z}/{x}/{y}.mvt',
          ],
        },
        planimetrics: {
          type: 'vector',
          tiles: [
            'https://cartocdn-gusc-b.global.ssl.fastly.net/planninglabs/api/v1/map/68d62d386cccebec5d2879d1f384302e:1551289016187/{z}/{x}/{y}.mvt',
          ],
        },
        'supporting-zoning': {
          type: 'vector',
          tiles: [
            'https://cartocdn-gusc-b.global.ssl.fastly.net/planninglabs/api/v1/map/94bd5cd5f35a73b1a68ff5047c196a5c:1557779848484/{z}/{x}/{y}.mvt',
          ],
        },
        'zoning-map-amendments': {
          type: 'vector',
          tiles: [
            'https://cartocdn-gusc-c.global.ssl.fastly.net/planninglabs/api/v1/map/2869748aecc315014c2e2031b298ef38:1557779981075/{z}/{x}/{y}.mvt',
          ],
        },
        'landmark-historic': {
          type: 'vector',
          tiles: [
            'https://cartocdn-gusc-d.global.ssl.fastly.net/planninglabs/api/v1/map/24879f01afb1a75e5ec0104cd9ed6008:1526570453789/{z}/{x}/{y}.mvt',
          ],
        },
        floodplains: {
          type: 'vector',
          tiles: [
            'https://cartocdn-gusc-c.global.ssl.fastly.net/planninglabs/api/v1/map/535f9eb31ccad4b6bdf6f17ff2e31513:1525336736357/{z}/{x}/{y}.mvt',
          ],
        },
        'preliminary-flood-insurance-rate': {
          type: 'vector',
          tiles: [
            'https://cartocdn-gusc-d.global.ssl.fastly.net/planninglabs/api/v1/map/910c2de8f349f70d920d63d8a73e5e5f:1525336736357/{z}/{x}/{y}.mvt',
          ],
        },
      },
