...
// locally-provided dummy tiles, fonts, etc.
  ...
  meta: {
    mapboxStyle: {
      ...
      sources: {
        openmaptiles: {
          type: 'vector',
          url: 'http://localhost:4200/mapbox-gl-test-data/static/v3.json',
        },
        paws: {
          type: 'vector',
          tiles: [
            'http://localhost:4200/mapbox-gl-test-data/dummy-tile.mvt',
          ],
        },
        'boat-launches': {
          type: 'vector',
      ...
      sprite: 'http://localhost:4200/mapbox-gl-test-data/static/sprite',
      glyphs: 'http://localhost:4200/mapbox-gl-test-data/fonts/dummy-font.pbf?noop={fontstack}{range}',
      layers: [
        {
          id: 'background',
          type: 'background',
