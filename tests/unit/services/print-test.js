...
module('Unit | Service | print', function (hooks) {
  ...
  test('printViewHiddenAreas computed property returns correct classes', function (assert) {
    ...
    assert.equal(
      printSvc.printViewHiddenAreas,
      '',
      'printViewHiddenAreas default value is okay'
    );
    ...
    assert.equal(
      printSvc.printViewHiddenAreas,
      'no-map no-legend',
      'printViewHiddenAreas observes changes to ShowMap and ShowLegend'
    );
    printSvc.set('printViewShowContent', false);
    assert.equal(
      printSvc.printViewHiddenAreas,
      'no-map no-legend no-content',
      'printViewHiddenAreas observes changes to ShowContent, too'
    );
  });
  ...
  test('printViewClasses computed property returns correct classes', function (assert) {
    ...
    assert.equal(
      ...
      '',
      'printViewClasses is blank when print disabled'
    );
    ...
    assert.equal(
      ...
      'printViewClasses observes changes to printViewPaperSize'
    );
    printSvc.set('printViewShowContent', false);
    assert.equal(
      printSvc.printViewClasses,
      'paper tabloid landscape no-content',
      'printViewClasses observes changes to printViewHiddenAreas'
    );
  });
});
